...
#khkimM
tf.app.flags.DEFINE_string(
    'dataset_dir', "/home/khkim/work/datasets/challenge/record", 'The directory where the dataset files are stored.')
...
#khkim
tf.app.flags.DEFINE_string(
    #'checkpoint_path', "preModel3/inception_v3_quant.ckpt",
    'checkpoint_path', "preModel/mobilenet_v2_1.4_224.ckpt",
