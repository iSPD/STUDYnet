...
public class CallFragment extends Fragment {
  ...
  public View onCreateView(
    ...
    View controlView = inflater.inflate(R.layout.communicate_fragment_call, container, false);
  ...
  public void onStart() {
    ...
    if (args != null) {
      String contactName = args.getString(CallManager.EXTRA_ROOMID);
      contactView.setText(contactName);
      videoCallEnabled = args.getBoolean(CallManager.EXTRA_VIDEO_CALL, true);
      captureSliderEnabled = videoCallEnabled
          && args.getBoolean(CallManager.EXTRA_VIDEO_CAPTUREQUALITYSLIDER_ENABLED, false);
    }
    if (!videoCallEnabled) {
  ...
  public void attachEvent(OnCallEvents events)
  {
    callEvents = events;
  }
