...
public final class UtilsLogger {
  private static final String DEFAULT_TAG = "studynet";
  ...
  static {
    ...
    IGNORED_CLASS_NAMES.add(UtilsLogger.class.getCanonicalName());
  }
   ...
   */
  public UtilsLogger(final Class<?> clazz) {
   ...
   */
  public UtilsLogger(final String messagePrefix) {
   ...
   *     being used
   */
  public UtilsLogger(final String tag, final String messagePrefix) {
    this.tag = tag;
  ...
  /** Creates a Logger using the caller's class name as the message prefix. */
  public UtilsLogger(final int minLogLevel) {
    this(DEFAULT_TAG, null);
  ...
  private static String getCallerSimpleName() {
    ...
    return UtilsLogger.class.getSimpleName();
  }
